...
- **Unibody 3" frame** for maximum rigidity and reduced vibrations
- **Truss-style reinforced arms**, derived from the Mars 2
...
- **2.5 mm carbon fiber:** balanced between strength and weight, stiff enough for the longer 3" arms.
...
- Reference build: **RCinPOWER GTS V3 1203 6000 Kv on 2S**
...
- **Motor screws:** M2 × 5-6 mm (depending on motor base thread depth)
- **AIO / stack mounting:**
  * 25.5 × 25.5 AIO → M2 × 10-18 mm (depending on stack and canopy)
...
- Order props with a **1.5 mm bore**. The GTS V3 1203 uses a 1.5 mm press-fit prop shaft, and 2 mm bore props will not fit
